...
export function buildImportSeoPrompt(productData: object, customPrompt?: string | null): string {
  const sections = [
    ...
    '- pisownia naturalna, bez powtarzania słów (wielkość liter nie ma znaczenia — system i tak sformatuje finalny tytuł)',
    '- używaj polskich znaków (ą, ę, ó, ł, ś, ź, ż, ć, ń)',
    '- nie używaj znaków specjalnych ani emoji w tytule: ! ? * # @',
    ...
    '- każdy akapit zacznij od 1 trafnego, pasującego tematycznie emoji (np. 📦 dostawa, ✅ jakość/gwarancja, 🛒 zachęta do zakupu) — subtelnie, bez przesady, maks. 1 emoji na akapit',
