...
import { getAiStatus } from '../services/ai.client';
import { getExternalSearchStatus } from '../services/external-search/external-search.status';
...
export async function getSearchSettings(_req: Request, res: Response) {
  res.json(getExternalSearchStatus());
}
