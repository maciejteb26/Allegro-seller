...
export function Step2Details({ data, onChange, showValidation }: Props) {
  ...
  function autoGenerateTitle() {
    ...
    if (data.productBrand) parts.unshift(data.productBrand);
    if (automotive && data.partSide && data.partSide !== 'Nie dotyczy') parts.push(data.partSide.toLowerCase());
  ...
  return (
    <div className="space-y-6">
      {/* Kategoria */}
      <div>
        <Label className="text-base font-semibold mb-2 block">Kategoria produktu</Label>
      ...
      <div>
        ...
        <Input
          id="title"
          placeholder="np. Samsung Galaxy S23 128GB czarny"
          value={data.title ?? ''}
      ...
      <div>
        ...
        <textarea
          id="description"
          rows={5}
          placeholder="Opisz produkt, stan, specyfikację i zastosowanie..."
      ...
      <div>
        ...
        <Input
          id="partDetails"
          placeholder="np. komplet akcesoriów, wersja europejska"
